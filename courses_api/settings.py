...
SECRET_KEY = 'django-insecure-@=f&p^c3y$f78&#rahib12@uw07rlggcttu6rk5nva^kl00-rq'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'mydatabase',     # Match this with POSTGRES_DB
...
STATICFILES_DIRS = [
    BASE_DIR / 'static',  # Adjust this if you have other directories for static files
]
